      ...
      {categories.map((categoryName) => {
        ...
        return (
          <div key={categoryName} className="mb-16 scroll-mt-[210px]">
            <h3 style={{ top: 'var(--sticky-category-top, 140px)' }} className="sticky z-[35] bg-ink pt-4 pb-3 mb-6 border-b border-panel-border text-gold-bright flex items-center justify-between text-2xl md:text-3xl font-bold tracking-wide shadow-sm">
