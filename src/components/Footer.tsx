    ...
    <footer id="location" className="bg-ink border-t border-panel-border text-cream pt-16 pb-12 px-6 scroll-mt-20">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 mb-12">
        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          <div className="space-y-3 text-sm text-stone">
            <div className="flex items-start gap-3">
              ...
              <span>681 E Chestnut Hill Rd, Newark, DE 19713</span>
            </div>

            <div className="flex items-center gap-3">
              <Phone className="w-5 h-5 text-gold shrink-0" />
              <a href="tel:+13023690553" className="hover:text-cream transition-colors font-semibold text-cream">
                (302) 369-0553
              </a>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-stone-dim">Sunday – Thursday: 9:00 AM – 9:00 PM</p>
                <p className="text-xs text-stone-dim">Friday – Saturday: 9:00 AM – 10:00 PM</p>
              </div>
            </div>
          </div>
        ...
        <div className="lg:col-span-7 h-[340px] rounded-2xl overflow-hidden border border-panel-border shadow-2xl relative bg-panel">
          <iframe
            title="Raggio Gourmet & Pizza Location"
      ...
      <div className="max-w-7xl mx-auto pt-8 border-t border-panel-border/60 flex flex-col md:flex-row items-center justify-between text-xs text-stone-dim gap-4">
